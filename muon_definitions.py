...
def get_pileup(resonance, era, subEra):
   ...
   dataPileup = {
       ...
       'Run2017UL_MiniAODv2_pilot': 'pileup/data/Run2017.root',
       'Run2017UL_MiniAOD_pilot': 'pileup/data/Run2017.root',
   ...
   mcPileup = {
       ...
       'Run2017UL_MiniAODv2_pilot': 'pileup/mc/Run2017_UL.root',
       'Run2017UL_MiniAOD_pilot': 'pileup/mc/Run2017_UL.root',
